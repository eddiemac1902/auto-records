    ...
    uploadImage(e) {
      ...
      if (file["size"] < 2111775) {
        reader.onloadend = () => {
          ...
          // alert(this.form.photo);
        };
        reader.readAsDataURL(file);
      } else {
        // alert("filebig");
        // this.form.errors.errors.photo[0] = "File size too large";
        toast({
          type: "error",
          title: "File size greater than 2mb"
        });
      }
    },
    updateUserInfo() {
      ...
      this.form
        ...
        .then(response => {
          ...
          Fire.$emit("userUpdatedEvent", "user updated");
        })
        .catch(error => {
          this.$Progress.fail();
        })
